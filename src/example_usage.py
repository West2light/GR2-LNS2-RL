...
def example_1_read_map():
    """Ví dụ 1: Đọc file map"""
    print("=" * 60)
    print("VÍ DỤ 1: ĐỌC FILE MAP")
    print("=" * 60)
    
    map_path = os.path.join(os.path.dirname(__file__), "..", "Map", "w_woundedcoast_map1.map")
...
def example_3_visualize_matplotlib():
...
def example_5_draw_custom_size():
...
def main():
    ...
    while True:
        print("\n" + "=" * 60)
        print("MENU - CHỌN VÍ DỤ")
        print("=" * 60)
        print("1. Đọc file map")
        ...
        if choice == '1':
            ...
            example_2_get_walkable()
        elif choice == '3':
            example_3_visualize_matplotlib()
        elif choice == '4':
            example_4_draw_pygame()
        elif choice == '5':
            example_5_draw_custom_size()
        elif choice == '0':
            print("Tạm biệt!")
            break
        else:
